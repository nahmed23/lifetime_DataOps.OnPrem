...
CREATE    PROC [dbo].[mmsDuesAssessment_Projection_Summary] (
...
-- =============================================
-- Object:            dbo.mmsDuesAssessment_Projection_Summary
-- Author:            Susan Myrick
...
--                    12/22/2011 LFF DBCR_06472
--                    8/8/2013 SRM DBCR_10663
-- Test Script:        Exec mmsDuesAssessment_Projection_Summary '141','May 1, 2011'
-- =============================================
...
SELECT 
       ...
       C.ClubName, COALESCE(FC.MembershipType, P.Description) AS MembershipType, 
       Count(MS.MembershipID) AS MembershipCount,
       VCC.CurrencyCode as LocalCurrencyCode,
       #PlanRate.PlanRate,
       @ReportingCurrencyCode as ReportingCurrencyCode,
       Sum(CASE WHEN FC.DuesPrice IS NOT NULL THEN (FC.DuesPrice * #PlanRate.PlanRate)
       ...
       Sum(CASE WHEN FC.DuesPrice IS NOT NULL THEN FC.DuesPrice
                WHEN CPTR.taxpercentage is null THEN CP.Price 
                ELSE CP.Price + (CP.Price*CPTR.taxpercentage/100) 
                END) as LocalCurrency_Sum_DuesPrice,         
       Sum(CASE WHEN FC.DuesPrice IS NOT NULL THEN FC.DuesPrice * #ToUSDPlanRate.PlanRate
                ...
                END) as USD_Sum_DuesPrice, 

       -- item amount       
       Sum(CASE WHEN FC.DuesItemAmount IS NOT NULL OR FC.DuesItemAmount<>0 THEN FC.DuesItemAmount * #PlanRate.PlanRate
                ELSE CP.Price * #PlanRate.PlanRate
                END) as DuesItemAmount,
       Sum(CASE WHEN FC.DuesItemAmount IS NOT NULL OR FC.DuesItemAmount<>0 THEN FC.DuesItemAmount 
                ELSE CP.Price 
                END) as LocalCurrency_DuesItemAmount, 
       Sum(CASE WHEN FC.DuesItemAmount IS NOT NULL OR FC.DuesItemAmount<>0 THEN FC.DuesItemAmount * #ToUSDPlanRate.PlanRate
                ELSE CP.Price * #ToUSDPlanRate.PlanRate
                END) as USD_DuesItemAmount,

       -- salex tax       
       Sum(CASE WHEN FC.DuesSalesTax IS NOT NULL OR FC.DuesSalesTax<> 0 THEN FC.DuesSalesTax * #PlanRate.PlanRate
                WHEN CPTR.taxpercentage is null THEN 0 
                ELSE (CP.Price * #PlanRate.PlanRate)*CPTR.taxpercentage/100 
                END) as DuesSalesTax, 
       Sum(CASE WHEN FC.DuesSalesTax IS NOT NULL OR FC.DuesSalesTax<> 0 THEN FC.DuesSalesTax
                WHEN CPTR.taxpercentage is null THEN 0 
                ELSE CP.Price*CPTR.taxpercentage/100 
                END) as LocalCurrency_DuesSalesTax, 
       Sum(CASE WHEN FC.DuesSalesTax IS NOT NULL OR FC.DuesSalesTax<> 0 THEN FC.DuesSalesTax * #ToUSDPlanRate.PlanRate
                WHEN CPTR.taxpercentage is null THEN 0 
                ELSE (CP.Price * #ToUSDPlanRate.PlanRate)*CPTR.taxpercentage/100 
                END) as USD_DuesSalesTax, 

       Sum(CASE WHEN FC.DuesPrice IS NOT NULL THEN 0 
       ...
       Sum(CASE WHEN FC.DuesPrice IS NOT NULL THEN 0
                ...
                END) as LocalCurrency_Sum_JuniorDuesPrice,
       Sum(CASE WHEN FC.DuesPrice IS NOT NULL THEN 0
                ...
                END) as USD_Sum_JuniorDuesPrice,

       -- junior itemamount       
       Sum(CASE WHEN FC.DuesPrice IS NOT NULL OR FC.DuesPrice<>0 THEN 0
...
Group By VR.Description,C.ClubName,COALESCE(FC.MembershipType, P.Description), VCC.CurrencyCode, #PlanRate.PlanRate
