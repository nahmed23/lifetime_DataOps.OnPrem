...
-- =============================================
-- Object:			mmsChildCenterCheckin_Summary_Scheduled
-- Author:			
-- Create date: 	
-- Description:		Child Center Usage Summary: all clubs MTD
-- Modified date:	8/1/2008 GRB; added conditional logic to handle first of month situation

-- Exec mmsChildCenterCheckin_Summary_Scheduled
-- =============================================

CREATE PROC [dbo].[mmsChildCenterCheckin_Summary_Scheduled]
...
--		SET @FirstOfMonth  =  CONVERT(DATETIME, SUBSTRING(CONVERT(VARCHAR, @Today, 112),1,6) + '01', 112)	8/1/2008 GRB
  ...
  EXEC dbo.mmsChildCenterCheckin_Summary 'All', @FirstOfMonth, @Today 
