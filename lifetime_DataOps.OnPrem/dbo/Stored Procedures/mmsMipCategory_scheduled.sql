...
-- =============================================
-- Object:			mmsMipCategory_scheduled
-- Author:			Greg Burdick
-- Create date: 	11/25/2008, released 11/26/2008 dbcr_3889a
-- Description:		
-- Modified date:	
-- Exec mmsMipCategory_scheduled
-- =============================================

CREATE PROC [dbo].[mmsMipCategory_scheduled]
...
--	SELECT @FirstOfCurrentMonth, @Yesterday
	EXEC dbo.mmsMipCategory 'All', @FirstOfCurrentMonth, @Yesterday
