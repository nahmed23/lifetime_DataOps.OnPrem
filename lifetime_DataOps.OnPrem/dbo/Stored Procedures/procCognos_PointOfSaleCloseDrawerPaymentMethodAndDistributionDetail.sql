...
CREATE PROC [dbo].[procCognos_PointOfSaleCloseDrawerPaymentMethodAndDistributionDetail] (
	 @StartDate DateTime,
	 @EndDate DateTime,
	 @ClubID INT,
...
------ Sample Execution
--- Exec procCognos_PointOfSaleCloseDrawerPaymentMethodAndDistributionDetail '2/1/2017','2/2/2017','151','474124|474156|474157|474158|474159|474160|479109|479207|459310'
------
...
---- Returns Payment and Refund transactions
SELECT distinct VDS.Description AS DrawerStatus, 
	   Region.Description AS MMSRegion,
       TranType.Description AS TranType, 
