...
/*	=============================================
	Object:			dbo.mmsMembershipAudit_PrimaryMember
	Author:			
	Create date: 	
	Description:	finding Primary Members in MembershipAudit Query
	...
	EXEC mmsMembershipAudit_PrimaryMember '131|144|21|126|22|20'
	=============================================	*/

CREATE PROC [dbo].[mmsMembershipAudit_PrimaryMember] (
