...
-- EXEC mmsGiftCardRedemptions_PaymenTech '141', 'Apr 1, 2011', 'Apr 30, 2011'

--
-- This query returns a listing of all gift cards redeemed for selected clubs within a
...
CREATE  PROCEDURE [dbo].[mmsGiftCardRedemptions_PaymenTech] (
...
/******  Foreign Currency Stuff  *********/
	   ...
	   SVCT.ResponseApprovedAmount * #PlanRate.PlanRate as ResponseApprovedAmount,	  
	   SVCT.ResponseApprovedAmount as LocalCurrency_ResponseApprovedAmount,	  
	   SVCT.ResponseApprovedAmount * #ToUSDPlanRate.PlanRate as USD_ResponseApprovedAmount	   
/***************************************/
...
WHERE SVCT.TransactionCode=73  ----- Redemptions only
