...
CREATE PROC [dbo].[procCognos_PromptForecastAssessmentDates] 
...
SELECT #Years.Year+'-'+#Months.Month YearMonth,
       ...
       Convert(DateTime,#Months.Month+'/'+Convert(Varchar,VAD.AssessmentDay)+'/'+#Years.Year) AssessmentDate_DateValue,    
